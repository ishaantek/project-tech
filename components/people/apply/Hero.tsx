            ...
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              <h1>
                ...
                <span className="mt-1 block text-5xl tracking-tight font-extrabold sm:text-6xl xl:text-6xl">
                  <span className="block text-gray-900">Join Project Tech</span>
              ...
              <p className="mt-3 text-lg text-gray-800 sm:mt-5 sm:text-xl">
                ...
                of leaders, creators, and computer science enthusiasts? Learn how to
                apply in the{' '}
                <a
                  target="_blank"
                ...
                >
                  Project Tech application packet
                </a>
                .
              </p>
              <p className="mt-3 text-base text-gray-800 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                Knowledge of computer science isn’t required for every position, and
