...
export default function AllBlogs() {
  ...
  const mediumUrl =
    'https://api.rss2json.com/v1/api.json?rss_url=https://project-tech.medium.com/feed'
        ...
        <div className="pb-8">
          ...
          <p className="text-xl text-gray-600">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              href="https://project-tech.medium.com/"
            >
              {` Project Tech's Medium page `}
            </a>
            for a list of articles related to computer science.
          </p>
        </div>
          ...
          {blogs.map((post) => (
            <div key={post.title} className="flex flex-col ">
              <div className="flex-1 bg-white p-6 flex flex-col justify-between rounded-lg border border-gray-200 shadow-md hover:shadow-lg">
                ...
                <div className="mt-6 flex items-center">
                  <div className="flex-shrink-0">
                    <a href={post.account} target="_blank" rel="noreferrer">
                      <div className="cursor-pointer">
