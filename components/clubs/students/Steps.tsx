...
const reasons = [
    ...
    content: (
      <div>
        ...
        <span className="font-bold text-yei-primary-main hover:text-yei-primary-darker">
          <Link href="/clubs/register">register page</Link>
        </span>{' '}
  ...
  },
  {
    ...
    content:
      'Schedule an onboarding call where we guide you with your transition in creating a new chapter of Project Tech.',
  },
  {
