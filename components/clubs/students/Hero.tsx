        ...
        <main className="">
          <div className="md:pt-10 mb-20 md:mb-40 mx-8 sm:mx-16 lg:ml-24 lg:mr-20 text-left">
            <h1 className="tracking-tight font-bold text-yei-primary-darker text-5xl mt-28 md:mt-48">
              ...
              <span className="mt-5 block">For students</span>
            </h1>
            <p className="mt-10 text-gray-500 text-2xl lg:mx-0">
              Start a Project Tech club at your school and become a leader in
              promoting computer science among your peers. With our support, you
              can access a comprehensive curriculum, training materials, and
              guidance from experienced mentors. Join our community and make a
              positive impact in your community today.
            </p>
