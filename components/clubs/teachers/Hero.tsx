        ...
        <main className="">
          <div className="md:pt-10 mb-20 md:mb-40 mx-8 sm:mx-16 lg:ml-24 lg:mr-20 text-left md:text-right lg:pr-10">
            <h1 className="tracking-tight font-bold text-yei-primary-darker text-5xl mt-28 md:mt-48">
              ...
              <span className="mt-5 block">For teachers</span>
            </h1>
            <p className="mt-10 text-gray-500 text-2xl lg:mx-0">
              Empower your students by starting a Project Tech club at your
              school. With our support, provide access to a comprehensive
              computer science curriculum, training, and mentorship. Join our
              community and inspire your students to explore their passion for
